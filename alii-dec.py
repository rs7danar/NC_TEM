...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/Kaewankarzan/NC_TEM/main/ID.txt").text 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m BO ID ACTIVE KRDN NAME BNIRA BO TELEGRAM @SHEXA_CRACK") 

      os.system('xdg-open  https://t.me/KAWA_SHAWESY')
